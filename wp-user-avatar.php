...
Description: Use any image in your WordPress Media Library as a custom user avatar. Add your own Default Avatar.
Version: 1.2.5
...
if(!class_exists('wp_user_avatar')){
  class wp_user_avatar{
    ...
    function media_upload_scripts(){
      ...
      wp_enqueue_script('wp-user-avatar', WP_USER_AVATAR_URLPATH.'js/wp-user-avatar.js', '', '1.2.5');
      wp_enqueue_style('wp-user-avatar', WP_USER_AVATAR_URLPATH.'css/wp-user-avatar.css', '', '1.2.5');
    }
  }
